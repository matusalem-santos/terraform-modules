...
resource "aws_security_group_rule" "ingress_with_source_security_group_id" {
  ...
  source_security_group_id = length(var.ingress_with_source_security_group_id[count.index]["source_security_group_id"]) > 0 ? var.ingress_with_source_security_group_id[count.index]["source_security_group_id"] : local.this_sg_id
  prefix_list_ids          = var.ingress_prefix_list_ids
  description = lookup(
