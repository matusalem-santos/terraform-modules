...
variable "usage_plan_count" {
  type        = number
  default     = 0
  description = "Number of count to create Usage Plan for api gateway."
}

variable "usage_plan_names" {
  type        = list(any)
  default     = []
  description = "The name of the API Usage Plan."
}

variable "usage_plan_descriptions" {
  type        = list(any)
  default     = []
  description = "The API Usage Plan description. Defaults to \"Managed by Terraform\"."
}

variable "usage_plan_burst_limit" {
  type        = list(any)
  default     = ["5000"]
  description = "The API Usage Plan Burst Limmit. Defaults to 5000"
}

variable "usage_plan_rate_limit" {
  type        = list(any)
  default     = ["10000"]
  description = "The API Usage Plan Rate Limit. Defaults to 10000"
}

variable "dns_regional_certificate_arn" {
  type     = string
  default = ""
...
variable "dns_api" {
  type     = string
  default = ""
  description = "Domain Name API"
}

variable "dns_tls_version" {
  type = string
  default = "TLS_1_2"
  description = "(optional) describe your variable"
}
...
variable "domain_name_enabled" {
  type = bool
  default = false
  description = "Whether to create Domain Name"
}
...
variable "vpc_link_description" {
  type = string
  default = ""
  description = "Descrição do vpc link"
}
...
variable "retention_in_days" {
    type = number
    default = 7
    description = "Retenção dos logs no log group"
}